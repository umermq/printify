      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="flex flex-col leading-none">
            <span className="font-serif text-xl font-semibold tracking-widest text-foreground group-hover:text-gold transition-colors duration-500">
              PrintPK
            </span>
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-72 bg-background border-border">
              <div className="mb-8 pt-2">
                <span className="font-serif text-xl font-semibold tracking-widest text-foreground">PrintPK</span>
                <span className="accent-line mt-1" />
              </div>
    ...
    <div className="container py-16">
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          <Link to="/" className="group inline-block">
            <span className="font-serif text-xl font-semibold tracking-widest text-primary-foreground">PrintPK</span>
          ...
          <div className="mt-6 flex items-center gap-4">
            <a href="https://facebook.com/printpk" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://instagram.com/printpk" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://tiktok.com/@printpk" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://youtube.com/@printpk" target="_blank" rel="noopener noreferrer"
      ...
      <div className="mt-12 border-t border-primary-foreground/10 pt-8">
        ...
        <p className="mt-6 text-center text-xs text-primary-foreground/25">
          © 2026 PrintPK. All rights reserved. Crafted with care in Pakistan.
        </p>
      </div>
    </div>
  </footer>
